...
required=(style.css functions.php header.php footer.php front-page.php index.php page.php 404.php readme.txt assets/js/theme.js assets/images/logo-mark.svg assets/images/logo-en.svg assets/images/logo-fa.svg assets/fonts/inter/inter-400.woff2 assets/fonts/inter/inter-600.woff2 assets/fonts/inter/inter-700.woff2 assets/fonts/inter/inter-800.woff2 assets/fonts/vazirmatn/vazirmatn-400.woff2 assets/fonts/vazirmatn/vazirmatn-500.woff2 assets/fonts/vazirmatn/vazirmatn-700.woff2 assets/fonts/vazirmatn/vazirmatn-800.woff2 inc/content.php inc/content-data.php)
