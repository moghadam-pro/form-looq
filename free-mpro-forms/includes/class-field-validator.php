...
final class Field_Validator {
	...
	public static function types(): array {
		return array(
			'text'     => array(
				'label'       => __( 'Single line text', 'free-mpro-forms' ),
				'icon'        => 'editor-textcolor',
				'has_options' => false,
			),
			'textarea' => array(
				'label'       => __( 'Paragraph text', 'free-mpro-forms' ),
				'icon'        => 'editor-alignleft',
				'has_options' => false,
			),
			'email'    => array(
				'label'       => __( 'Email', 'free-mpro-forms' ),
				'icon'        => 'email',
				'has_options' => false,
			),
			'tel'      => array(
				'label'       => __( 'Phone', 'free-mpro-forms' ),
				'icon'        => 'phone',
				'has_options' => false,
			),
			'number'   => array(
				'label'       => __( 'Number', 'free-mpro-forms' ),
				'icon'        => 'calculator',
				'has_options' => false,
			),
			'select'   => array(
				'label'       => __( 'Dropdown', 'free-mpro-forms' ),
				'icon'        => 'menu',
				'has_options' => true,
			),
			'radio'    => array(
				'label'       => __( 'Radio buttons', 'free-mpro-forms' ),
				'icon'        => 'marker',
				'has_options' => true,
			),
			'checkbox' => array(
				'label'       => __( 'Checkbox', 'free-mpro-forms' ),
				'icon'        => 'yes',
				'has_options' => false,
			),
			'scale'    => array(
				'label'       => __( 'Rating scale', 'free-mpro-forms' ),
				'icon'        => 'star-filled',
				'has_options' => true,
			),
			'section'  => array(
				'label'       => __( 'Section break', 'free-mpro-forms' ),
				'icon'        => 'minus',
				'has_options' => false,
			),
		);
