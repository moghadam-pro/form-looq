...
final class Entries_List_Table extends \WP_List_Table {
	...
	public function get_columns(): array {
		...
		$columns['status']     = __( 'Status', 'form-looq' );
		$columns['created_at'] = __( 'Submitted', 'form-looq' );
	...
	protected function get_bulk_actions(): array {
		return array(
			'mark_read'   => __( 'Mark as read', 'form-looq' ),
			'mark_unread' => __( 'Mark as unread', 'form-looq' ),
			'delete'      => __( 'Delete', 'form-looq' ),
		);
	}

	public function no_items(): void {
		esc_html_e( 'No entries found.', 'form-looq' );
	}
	...
	protected function column_id( array $item ): string {
		...
		$actions = array(
			'view'   => sprintf( '<a href="%s">%s</a>', esc_url( $view_url ), esc_html__( 'View', 'form-looq' ) ),
			'delete' => sprintf(
				'<a class="submitdelete looq-confirm" data-looq-confirm="%s" href="%s">%s</a>',
				esc_attr__( 'Delete this entry permanently?', 'form-looq' ),
	...
	protected function extra_tablenav( $which ): void {
		...
		<div class="alignleft actions">
			<label class="screen-reader-text" for="looq-entry-status"><?php esc_html_e( 'Filter by status', 'form-looq' ); ?></label>
			<select name="entry_status" id="looq-entry-status">
				<option value=""><?php esc_html_e( 'All entries', 'form-looq' ); ?></option>
	...
	public function single_row( $item ): void {
		$classes = Entry_Repository::STATUS_UNREAD === $item['status'] ? 'looq-entry-unread' : '';
