...
$plugin_file = WP_PLUGIN_DIR . '/form-looq/form-looq.php';
...
$entry_id = form_looq_store_submission(
	$form_id,
	array(
...
$rendered = do_shortcode( sprintf( '[looq_form id="%d"]', $form_id ) );

if ( false === strpos( $rendered, 'looq-form' ) ) {
