...
fmpf_rate_test_assert( false === $third['allowed'], 'The configured rate limit did not block the third attempt.' );
fmpf_rate_test_assert( $third['retry_after'] > 0, 'The blocked response did not include a retry interval.' );
