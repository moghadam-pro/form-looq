...
final class Remote_Content {
	...
	private const TRANSIENT_ADDONS = 'mpro_forms_remote_addons';
	private const TRANSIENT_DOCS   = 'mpro_forms_remote_docs';
	...
	private static function fetch( string $url, string $transient ): array {
		...
		$response = wp_remote_get(
			...
			array(
				...
				'user-agent' => 'MPROForms/' . MPRO_FORMS_VERSION . '; ' . home_url( '/' ),
	...
	private static function fallback_addons(): array {
		return array(
			array(
				'slug'        => 'polls',
				'name'        => __( 'Polls', 'mpro-forms' ),
				'description' => __( 'Single-question polls with live result bars.', 'mpro-forms' ),
				'icon'        => 'chart-bar',
				'status'      => 'planned',
			),
			array(
				'slug'        => 'email-notifications',
				'name'        => __( 'Email notifications', 'mpro-forms' ),
				'description' => __( 'Send admin alerts and visitor confirmations after each entry.', 'mpro-forms' ),
				'icon'        => 'email-alt',
				'status'      => 'planned',
			),
			array(
				'slug'        => 'discount-codes',
				'name'        => __( 'Discount codes', 'mpro-forms' ),
				'description' => __( 'Validate coupon codes inside order forms.', 'mpro-forms' ),
				'icon'        => 'tickets-alt',
				'status'      => 'planned',
			),
			array(
				'slug'        => 'quiz',
				'name'        => __( 'Quiz', 'mpro-forms' ),
				'description' => __( 'Scored questions with pass marks and per-answer feedback.', 'mpro-forms' ),
				'icon'        => 'welcome-learn-more',
				'status'      => 'planned',
			),
			array(
				'slug'        => 'survey',
				'name'        => __( 'Survey', 'mpro-forms' ),
				'description' => __( 'Multi-page surveys with aggregated reporting.', 'mpro-forms' ),
				'icon'        => 'feedback',
				'status'      => 'planned',
			),
			array(
				'slug'        => 'registration',
				'name'        => __( 'User registration', 'mpro-forms' ),
				'description' => __( 'Create WordPress accounts from a form submission.', 'mpro-forms' ),
				'icon'        => 'admin-users',
				'status'      => 'planned',
			),
		);
