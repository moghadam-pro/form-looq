...
final class Dashboard_Widget {
	...
	public static function render(): void {
		...
		<div class="mpro-dashboard">
			...
			<?php else : ?>
				<p><?php esc_html_e( 'No forms yet.', 'mpro-forms' ); ?></p>
			<?php endif; ?>
