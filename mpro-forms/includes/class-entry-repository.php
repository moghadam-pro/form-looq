...
final class Entry_Repository {
	...
	public static function statuses(): array {
		return array(
			self::STATUS_UNREAD => __( 'Unread', 'mpro-forms' ),
			self::STATUS_READ   => __( 'Read', 'mpro-forms' ),
		);
	}
	...
	public static function create( int $form_id, array $data, array $context = array() ): int {
		 ...
		 */
		do_action( 'mpro_forms_entry_created', $entry_id, $form_id );
	...
	public static function delete( int $entry_id ): bool {
		 ...
		 */
		do_action( 'mpro_forms_entry_deleted', $entry_id );
	...
	public static function recount_all(): void {
		...
		if ( function_exists( 'wp_cache_flush_group' ) ) {
			wp_cache_flush_group( 'mpro_forms' );
		}
	}
