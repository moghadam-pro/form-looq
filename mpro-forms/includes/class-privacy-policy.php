...
final class Privacy_Policy {
	...
	public static function add_content(): void {
		...
		$content .= '<p>' . esc_html__( 'The core plugin does not send submissions to the plugin author, does not require a cloud account, and does not enable analytics or telemetry. Optional integrations added in future versions may process data through another service and should be disclosed separately when enabled.', 'mpro-forms' ) . '</p>';
