...
final class Field_Validator {
	...
	public static function types(): array {
		return array(
			'text'     => array(
				'label'       => __( 'Single line text', 'mpro-forms' ),
				'icon'        => 'editor-textcolor',
				'has_options' => false,
			),
			'textarea' => array(
				'label'       => __( 'Paragraph text', 'mpro-forms' ),
				'icon'        => 'editor-alignleft',
				'has_options' => false,
			),
			'email'    => array(
				'label'       => __( 'Email', 'mpro-forms' ),
				'icon'        => 'email',
				'has_options' => false,
			),
			'tel'      => array(
				'label'       => __( 'Phone', 'mpro-forms' ),
				'icon'        => 'phone',
				'has_options' => false,
			),
			'number'   => array(
				'label'       => __( 'Number', 'mpro-forms' ),
				'icon'        => 'calculator',
				'has_options' => false,
			),
			'select'   => array(
				'label'       => __( 'Dropdown', 'mpro-forms' ),
				'icon'        => 'menu',
				'has_options' => true,
			),
			'radio'    => array(
				'label'       => __( 'Radio buttons', 'mpro-forms' ),
				'icon'        => 'marker',
				'has_options' => true,
			),
			'checkbox' => array(
				'label'       => __( 'Checkbox', 'mpro-forms' ),
				'icon'        => 'yes',
				'has_options' => false,
			),
			'scale'    => array(
				'label'       => __( 'Rating scale', 'mpro-forms' ),
				'icon'        => 'star-filled',
				'has_options' => true,
			),
			'section'  => array(
				'label'       => __( 'Section break', 'mpro-forms' ),
				'icon'        => 'minus',
				'has_options' => false,
			),
		);
